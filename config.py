...
OWNER_ID = int(getenv("OWNER_ID", 8011306629))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/JaniPrivetRepo/Radhya",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/vrzw4f.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/vrzw4f.jpg")
